    ...
    <>
         <section className="container mx-auto py-10 text-gray-600 dark:text-gray-300">
            ...
            <div className='grid gap-y-6 lg:gap-y-0 lg:flex sm:gap-x-6 lg:gap-x-6'>
              {/* main div */}
              <div className="sm:max-w-xl shadow">
                <div className="max-h-80">
                  <img
                    className="sm:min-h-[18rem] bg-cover object-cover"
              ...
              <div className="lg:max-w-xs shadow">
                <div className="max-h-72 overflow-hidden">
                  <img
                    className="bg-center object-cover xl:h-72 w-full"
              ...
              {/* Treding / Latest Post  */}
              <div className="sm:w-72 md:w-80 xl:w-96 hidden sm:block">
                <div className="grid grid-cols-2">
                  <button onClick={()=>{setShow(true)}} className={`text-md font-mono py-1 border rounded-l hover:border-orange-600 hover:text-orange-600 ${show === true ? 'text-orange-600 border-orange-600' : 'text-gray-500 border-gray-600 border-opacity-50' }`}>
                    TRENDING
                  </button>
                  <button onClick={()=>{setShow(false)}} className={`text-md font-mono py-1 border rounded-r hover:border-orange-600 hover:text-orange-600 ${show === false ? 'text-orange-600 border-orange-600' : 'text-gray-500 border-gray-600 border-opacity-50' }`}>
                    LATEST
                  </button>
                </div>

                {/* Trending Block  */}
               {show === true ? <div className="my-8 trending grid gap-y-6">
                  <div className="flex gap-x-3">
                    <div className="w-24 h-20 xl:w-30 xl:h-22 overflow-hidden">
                      <img
                    ...
                    <div className="w-44 lg:w-52 -translate-y-1 lg:-translate-y-0.5">
                      <h4 className="text-md font-semibold blog-title">
                        Lorem ipsum dolor sit sot , amet consectetur
