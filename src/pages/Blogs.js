...
<div className='my-6 grid gap-y-6 lg:grid-cols-2 lg:gap-x-6 xl:gap-x-8'>
  ...
  <div className='grid grid-cols-2 gap-3 lg:gap-x-4'>
    ...
    <div>
    <p className="absolute top-1 left-2 md:top-2 md:left-3 text-xs text-orange-600 font-semibold">Technology</p>
    <h3 className="my-1 text-sm md:my-2 md:text-md font-semibold blog-title">Lorem ipsum dolor sit amet, consectetur adipisicing.</h3>
    ...
    <div>
    <p className="absolute top-1 left-2 md:top-2 md:left-3 text-xs text-orange-600 font-semibold">Sports</p>
    <h3 className="my-1 text-sm md:my-2 md:text-md font-semibold blog-title">Lorem ipsum dolor sit amet, consectetur adipisicing.</h3>
      <p className="text-xs lg:text-sm flex items-center gap-x-1 text-gray-500">
        <WiTime8/>
        <span className="font-semibold">
